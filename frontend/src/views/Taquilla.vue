  ...
  <div class="mt-4">
        ...
        <div class="col-md-4 mb-4" v-for="funcion in funciones" :key="funcion.IDfuncion">
          <div class="card h-100 shadow-sm border-0">
            <div class="card-body">
              ...
              <button class="btn btn-dark w-100" @click="seleccionarFuncion(funcion)">
    ...
    <div v-if="funcionSeleccionada">
      ...
      <div class="card shadow-sm border-0 p-4">
        ...
        <p class="text-muted mb-0">Sala: {{ funcionSeleccionada.Sala }} | Horario: {{ formatearFecha(funcionSeleccionada.FechaHora) }} | Precio: Q. {{ funcionSeleccionada.Precio }}</p>
        <hr>
        ...
        <div class="mt-4 p-3 bg-light rounded text-center overflow-auto">
          ...
          <div v-for="(listaAsientos, letra) in asientosAgrupados" :key="letra" class="d-flex justify-content-center align-items-center mb-2">
            ...
            <div class="d-flex gap-2">
              <button 
                v-for="asiento in listaAsientos" 
                :key="asiento.IDasiento"
                class="btn border-0 bg-transparent d-flex flex-column align-items-center p-1 mx-1"
                style="width: 55px;"
                :class="{
                ...
                :disabled="asiento.Ocupado === 1"
                @click="toggleAsiento(asiento)"
              >
                <!-- Libre -->
                <i v-if="asiento.Ocupado === 0 && !esSeleccionado(asiento.IDasiento)" class="bi bi-display fs-3" style="line-height: 1;"></i>
                
                <!-- Seleccionado -->
                <i v-if="esSeleccionado(asiento.IDasiento)" class="bi bi-check-circle-fill fs-3" style="line-height: 1;"></i>
        ...
        <div class="mt-4 alert alert-secondary d-flex justify-content-between align-items-center shadow-sm">
          <span><strong>Butacas seleccionadas:</strong> {{ asientosSeleccionados.length }} | <strong>Total a pagar:</strong> Q. {{ totalPagar }}</span>
          <button 
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
          ...
          <div class="modal-body p-4">
            ...
            <button 
                class="btn btn-success w-100 fw-bold shadow" 
